...
namespace Ankama.Cube.UI.Components
{
	...
	public class CustomDropdown : Selectable, IPointerClickHandler, IEventSystemHandler, ISubmitHandler, ICancelHandler
	{
		...
		public void RefreshShownValue()
		{
			...
			if (Object.op_Implicit(m_CaptionText))
			{
				...
				{
					m_CaptionText.set_text(val.get_text());
				}
				else
				{
					m_CaptionText.set_text("");
				}
			}
			if (Object.op_Implicit(m_CaptionImage))
			{
		...
		private DropdownItem AddItem(OptionData data, bool selected, DropdownItem itemTemplate, List<DropdownItem> items)
		{
			...
			{
				dropdownItem.text.set_text(data.get_text());
			}
