...
{
	[Serializable]
	public sealed class FirstCastTargetSelector : IEditableContent, ITargetSelector, ISingleEntitySelector, IEntitySelector, ISingleTargetSelector, ISingleCoordSelector, ICoordSelector
	{
		...
		public static FirstCastTargetSelector FromJsonToken(JToken token)
		{
			...
			FirstCastTargetSelector firstCastTargetSelector = new FirstCastTargetSelector();
			firstCastTargetSelector.PopulateFromJson(jsonObject);
			return firstCastTargetSelector;
		}

		public static FirstCastTargetSelector FromJsonProperty(JObject jsonObject, string propertyName, FirstCastTargetSelector defaultValue = null)
		{
