...
namespace Ankama.Cube.Data
{
	...
	public sealed class HerdCondition : EffectCondition
	{
		...
		private static readonly FilteredEntitySelector selector = FilteredEntitySelector.From(OwnerFilter.sameAsCaster, new OsamodasAnimalsEntityFilter());
		...
		public new static HerdCondition FromJsonToken(JToken token)
		{
		...
		public static HerdCondition FromJsonProperty(JObject jsonObject, string propertyName, HerdCondition defaultValue = null)
		{
