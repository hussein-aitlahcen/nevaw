...
namespace Ankama.Cube.Data
{
	public class ISingleCaracIdSelectorUtils
	{
		public static ISingleCaracIdSelector FromJsonToken(JToken token)
		{
			...
			if (text == "CaracIdDirectSelector")
			{
				ISingleCaracIdSelector singleCaracIdSelector = new CaracIdDirectSelector();
				singleCaracIdSelector.PopulateFromJson(val);
		...
		public static ISingleCaracIdSelector FromJsonProperty(JObject jsonObject, string propertyName, ISingleCaracIdSelector defaultValue = null)
		{
