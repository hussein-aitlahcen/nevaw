...
namespace Ankama.Cube.Data
{
	...
	public sealed class CanGrowEntityFilter : IEditableContent, IEntityFilter, ITargetFilter
	{
		...
		public static CanGrowEntityFilter FromJsonToken(JToken token)
		{
			...
			CanGrowEntityFilter canGrowEntityFilter = new CanGrowEntityFilter();
			canGrowEntityFilter.PopulateFromJson(jsonObject);
			return canGrowEntityFilter;
		}

		public static CanGrowEntityFilter FromJsonProperty(JObject jsonObject, string propertyName, CanGrowEntityFilter defaultValue = null)
		{
