...
namespace Ankama.Cube.Data
{
	...
	public sealed class OrCondition : EffectCondition
	{
		...
		public new static OrCondition FromJsonToken(JToken token)
		{
		...
		public static OrCondition FromJsonProperty(JObject jsonObject, string propertyName, OrCondition defaultValue = null)
		{
