...
{
	[Serializable]
	public sealed class ApplicationHolderSelector : IEditableContent, ITargetSelector, ISingleEntitySelector, IEntitySelector, ISingleTargetSelector
	{
		...
		public static ApplicationHolderSelector FromJsonProperty(JObject jsonObject, string propertyName, ApplicationHolderSelector defaultValue = null)
		{
