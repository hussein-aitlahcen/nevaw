...
namespace Ankama.Cube.Data
{
	...
	public sealed class PropertyFilter : IEditableContent, IEntityFilter, ITargetFilter
	{
		...
		public PropertyId property => m_property;
		...
		public static PropertyFilter FromJsonProperty(JObject jsonObject, string propertyName, PropertyFilter defaultValue = null)
		{
		...
		{
			m_property = (PropertyId)Serialization.JsonTokenValue<int>(jsonObject, "property", 0);
		}
