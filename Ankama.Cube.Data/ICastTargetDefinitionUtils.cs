...
namespace Ankama.Cube.Data
{
	public class ICastTargetDefinitionUtils
	{
		public static ICastTargetDefinition FromJsonToken(JToken token)
		{
			...
			ICastTargetDefinition castTargetDefinition;
			switch (text)
			{
			case "OneCastTargetDefinition":
				castTargetDefinition = new OneCastTargetDefinition();
				break;
			case "TwoCastTargetDefinition":
				castTargetDefinition = new TwoCastTargetDefinition();
				break;
			case "MultipleCastTargetDefinition":
				castTargetDefinition = new MultipleCastTargetDefinition();
				break;
			default:
				Debug.LogWarning((object)("Unknown type: " + text));
				return null;
			}
			castTargetDefinition.PopulateFromJson(val);
			return castTargetDefinition;
		}

		public static ICastTargetDefinition FromJsonProperty(JObject jsonObject, string propertyName, ICastTargetDefinition defaultValue = null)
		{
