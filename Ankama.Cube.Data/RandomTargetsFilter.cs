...
{
	[Serializable]
	public sealed class RandomTargetsFilter : IEditableContent, ICoordOrEntityFilter, ICoordFilter, ITargetFilter, IEntityFilter
	{
		...
		public static RandomTargetsFilter FromJsonProperty(JObject jsonObject, string propertyName, RandomTargetsFilter defaultValue = null)
		{
